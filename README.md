...
A lightweight, dependency-free repository containing pure Python and C implementations of the standard Modbus RTU CRC-16 algorithm.
...
If you are currently on-site, covered in grease, and need a quick way to verify frames on your phone without firing up an IDE or running Python scripts, we hosted a visual version of this calculator here:
